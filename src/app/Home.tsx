...
//     return (
//         <div>
//             <main className='mt-20 w-full h-auto items-center flex flex-col'>
//                 <div>
...
//                     </div>
//                 </div>
//                 <div className='w-full h-[1920px] bg-white flex flex-col'>
...
//                         height={500}
//                         alt='CAMISA1' />
//                     <div className="w-full h-[500px] bg-black flex flex-col pl-[10%] justify-center">
...
//                 </div>
//             </main>
//             <footer className="w-full h-auto mt-64">
//                 <Footer />
//             </footer>
//         </div>
